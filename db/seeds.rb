...
getting_started_id = Category.find_by_name('Getting Started').id
renovation_id = Category.find_by_name('Renovation').id
branding_id = Category.find_by_name('Branding').id
fundraiser_id = Category.find_by_name('The Fundraiser').id
network_id = Category.find_by_name('Your School Network').id
partnering_up_id = Category.find_by_name('Partnering Up').id
